...
class Fitbit(object):
    ...
    def __init__(self, client_key, client_secret, system=US, client=None, **kwargs):
        """
        ...
        self.client = client or FitbitOauth2Client(client_key, client_secret, **kwargs)
    ...
    def update_activity_daily_goal(self, calories_out=None, active_minutes=None,
    ...
    def get_activity_daily_goal(self):
        return self.update_activity_daily_goal()

    def update_activity_weekly_goal(self, distance=None, floors=None, steps=None):
        """
        Implements the following APIs
    ...
    def get_activity_weekly_goal(self):
        return self.update_activity_weekly_goal()
    ...
    def get_time_series(self, resource, user_id=None, base_date='today',
    ...
    def _get_activity_stats(self, user_id=None, qualifier=''):
        """
    ...
    def get_lifetime_stats(self, user_id=None):
        return self._get_activity_stats(user_id)

    # def get_recent_activities(self, user_id=None):
    #     return self._get_activity_stats(user_id, '/recent')
    #
    # def get_favorite_activities(self, user_id=None):
    #     return self._get_activity_stats(user_id, '/favorite')
    #
    # def get_frequent_activities(self, user_id=None):
    #     return self._get_activity_stats(user_id, '/frequent')
    ...
    #     start_time should be a datetime object. We will be using the year, month, day, hour, and minute.
    #     """
    #     data = {
